...
<html>
  ...
  <body>
    ...
    <h2 class="mb-3">Search results for: "${HeadTitle}"</h2>
      <div class="row">
        <!-- Latest Posts -->
              ...
              <div class="post col-xl-6">
                ...
                <div class="post-details">
                  <div class="post-meta d-flex justify-content-between">
                    ...
                    <div class="category"><a href="/blog-category/${blog.category.seoTitle}/${blog.category.id}">"${blog.category.name}"</a></div>
                  ...
                  <footer class="post-footer d-flex align-items-center"><a href="/blog-author/${blog.user.seoTitle}/${blog.user.username}" class="author d-flex align-items-center flex-wrap">
                      <div class="avatar"><img src="${pageContext.request.contextPath}/admin/slike/${blog.user.image}" alt="..." class="img-fluid"></div>
            ...
            <nav aria-label="Page navigation example">
              <ul class="pagination pagination-template d-flex justify-content-center">
                ...
                <c:when test="${curentPage != 1}">
                	<li class="page-item"><a href="/blog-search/${curentPage - 1}/?text=${HeadTitle}"  class="page-link"> <i class="fa fa-angle-left"></i></a></li>
                </c:when>
                <c:otherwise>
                	<li class="page-item"><a href="/blog-search/${curentPage}/?text=${HeadTitle}" class="page-link"> <i class="fa fa-angle-left"></i></a></li>
                </c:otherwise>
                </c:choose>
                ...
                <c:forEach begin="1" end="${totalPage}" varStatus="broj">
                   ...
                   <c:when test="${broj.count == curentPage}">
                	 <li class="page-item"><a href="/blog-search/${broj.count}/?text=${HeadTitle}" class="page-link active">${broj.count}</a></li>
                    </c:when>
                    <c:otherwise>
                	  <li class="page-item"><a href="/blog-search/${broj.count}/?text=${HeadTitle}" class="page-link">${broj.count}</a></li></c:otherwise>
                	</c:choose>        		
                ...
                <c:when test="${curentPage != totalPage}">
                	<li class="page-item"><a href="/blog-search/${curentPage + 1}/?text=${HeadTitle}" class="page-link"> <i class="fa fa-angle-right"></i></a></li>
                </c:when>
                <c:otherwise>
                	<li class="page-item"><a href="/blog-search/${curentPage}/?text=${HeadTitle}" class="page-link"> <i class="fa fa-angle-right"></i></a></li>
                </c:otherwise>
                </c:choose>       		
