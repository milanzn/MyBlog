            ...
            <nav aria-label="Page navigation example">
              <ul class="pagination pagination-template d-flex justify-content-center">
                ...
                <c:when test="${curentPage != 1}">
                	<li class="page-item"><a href="/blog/${curentPage - 1}" class="page-link"> <i class="fa fa-angle-left"></i></a></li>
                </c:when>
                <c:otherwise>
                	<li class="page-item"><a href="/blog/${curentPage}" class="page-link"> <i class="fa fa-angle-left"></i></a></li>
                </c:otherwise>
                </c:choose>
                ...
                <c:forEach begin="1" end="${totalPage}" varStatus="broj">    
                     <c:choose>
                		...
                		<li class="page-item"><a href="/blog/${broj.count}" class="page-link active">${broj.count}</a></li>
                		</c:when>
                		<c:otherwise>
                		<li class="page-item"><a href="/blog/${broj.count}" class="page-link">${broj.count}</a></li></c:otherwise>
                	</c:choose>
        		</c:forEach>
        		
                 <c:choose>
                <c:when test="${curentPage != totalPage}">
                	<li class="page-item"><a href="/blog/${curentPage + 1}" class="page-link"> <i class="fa fa-angle-right"></i></a></li>
                </c:when>
                <c:otherwise>
                	<li class="page-item"><a href="/blog/${curentPage}" class="page-link"> <i class="fa fa-angle-right"></i></a></li>
                </c:otherwise>
                </c:choose>       		
