...
<head>
  ...
  <meta http-equiv="x-ua-compatible" content="ie=edge">
    ...
    <title>Cubes school - My Blog</title>
  <!-- Select2 -->
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form:form action="blog-save" role="form" modelAttribute="blog" method="post" enctype="multipart/form-data">
              	<form:hidden path="id"/>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                			...
                			<div class="card-body pad">
								<div class="mb-3"></div>
             						<p class="text-sm mb-0">
               							Editor 
               						<a href="https://github.com/bootstrap-wysiwyg/bootstrap3-wysiwyg">Documentation and license
               								information.
               						</a>
                      ...
                      <div class="form-group">
                        <label>Views</label>
                        <form:input type="text" class="form-control" placeholder="Enter views" path="views" readonly="true"/>
                      </div>  
                      <div class="form-group">
                        <label>Author</label>
                        <form:input class="form-control" path="user" itemLabel="name" itemValue="username" items="${users}" readonly="true"/>
                      </div>                       
